...
dataset = pd.DataFrame({
    "Linear von Mises Stress (σ, MPa)": [340.1523409, 377.6361498, 315.78422996, 189.1191317, 168.9092521, 324.0507576, 176.7300265],
    "Linear Max Principal Stress (σ, MPa)": [376.1708725, 418.9411742, 346.9163822, 209.3657783, 185.9875863, 356.8389866, 195.4201101],
    "Linear Equivalent Strain (ε, mm/mm)": [0.001700776, 0.0018888342, 0.001578922, 0.000945607, 0.000844547, 0.001620255, 0.000883657],
    "Nonlinear von Mises Stress (σ, MPa)": [256.9695163, 250.2192236, 253.0039444, 189.0856522, 168.8918588, 250.3515208, 176.7046842],
    "Nonlinear Max Principal Stress (σ, MPa)": [289.4311823, 296.7278234, 284.9992443, 209.3166919, 185.9579268, 287.2069086, 195.3819725],
    "Nonlinear Plastic Strain (ε, mm/mm)": [0.000582405, 0.000913638, 0.000405511, 0, 0, 0.000474101, 0],
    "Nonlinear Total Strain (ε, mm/mm)": [0.001836659, 0.002170315, 0.001658473, 0.000945439, 0.00084446, 0.001727564, 0.00088353],
...
with st.expander("Dataset Overview"):
    ...
    styled_dataset = formatted_dataset.style.set_table_styles(
        [{'selector': 'th', 'props': [('white-space', 'normal'), ('word-wrap', 'break-word')]}]  # Wrapping header text
    ).set_properties(
